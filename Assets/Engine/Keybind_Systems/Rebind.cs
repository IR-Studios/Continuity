...
public class Rebind : MonoBehaviour
{
    ...
    {
        ConfigFilePath = Application.dataPath + @"/Config/Keybinds";
    ...
    public static string GetEntry(string actionName) 
    {
        for (int i=0; i < keys.Dictionary.Count; i++) 
        {
            return keys.Dictionary[actionName][i].ToString();
        }
        return "[NO KEY BOUND]";
